...
echo ""
echo "Done. Tables: tangify_sessions, tangify_orders, tangify_bills, tangify_bills_with_line_items, dev-tangify_bills_with_line_items, tangify_users, tangify_points_wallet, tangify_phone_otp"
if [[ -n "${ENDPOINT_URL:-}" ]]; then
